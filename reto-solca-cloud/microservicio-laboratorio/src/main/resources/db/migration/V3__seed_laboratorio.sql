INSERT IGNORE INTO resultados_laboratorio (id_paciente_regional, sede, fecha_ejecucion, tipo_examen, resultado, valores_referencia, medico_solicitante, area, metodo, anormal) VALUES
